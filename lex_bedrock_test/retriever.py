...
class KBRetriever:
    def __init__(self,llm, knowledge_base_id, retrieval_config):
        self.llm = llm
        self.retriever = AmazonKnowledgeBasesRetriever(
            knowledge_base_id=knowledge_base_id,
            retrieval_config=retrieval_config
        )
        self.history_aware_retriever = self.create_retriever_with_chat_history()
